...
default_path = "data/lc3/settings.json"

class Settings:
    def __init__(self,path=default_path):
        self.path = path
        self.check_folders()
        self.default_settings = {"EMAIL" : "EmailHere", "PASSWORD" : "PasswordHere", "OWNER" : "id_here", "PREFIXES" : [], "default":{"ADMIN_ROLE" : "Admins", "MOD_ROLE" : "Moderators"}}
